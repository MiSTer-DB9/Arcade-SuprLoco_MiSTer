...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-SuprLoco_MiSTer.git"
CORE_NAME=(Arcade-SuprLoco)
...
UPSTREAM_CORE_NAME=(Arcade-SuprLoco)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-SuprLoco.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-SuprLoco.rbf)
